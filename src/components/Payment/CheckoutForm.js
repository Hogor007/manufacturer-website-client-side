...
const CheckoutForm = (props) => {
  ...
  useEffect(() => {
    fetch("https://enigmatic-beyond-17898.herokuapp.com/create-payment-intent", {
      method: "POST",
      headers: {
  ...
  useEffect(() => {
    if (transactionId) {
      fetch(
        `https://enigmatic-beyond-17898.herokuapp.com/orders/${requiredOrder?._id}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
    ...
    <div>
      <form onSubmit={handleSubmit}>
        ...
        <div className="d-flex justify-content-around">
          ...
          <button
            type="submit"
            class="btn btn-primary d-block mx-auto mt-4 px-5 py-2"
